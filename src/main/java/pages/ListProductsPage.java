...
public class ListProductsPage {
    ...
    public boolean hasTableRow(String name, String type, boolean isExotic) { // метод поиска строки таблицы с атрибутами добавленного овоща/фрукта
        String isExoticText = isExotic ? "true" : "false";
        By row = By.xpath(".//tr[td//text() = '" + name + "' and td//text() = '" + type + "' and td//text() = '" + isExoticText + "']");
